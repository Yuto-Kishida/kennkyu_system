...
//console.log(word);
let word = ["/firsttext/first.png", "/firsttext/slow.png","/firsttext/good.png","/firsttext/tired.png","/firsttext/can.png","/firsttext/difficult.png","/firsttext/year.png","/firsttext/nice.png","/firsttext/fight.png","/firsttext/yoroshiku_demo.png"];
...
let fontSize = [[308,146],[349,134],[456,111],[316,147],[451,128],[459,102],[341,100],[300,300],[300,300],[400,400]]
let fontSize2 = [[232,157],[405,117],[456,121],[405,133],[543,170],[557,116],[519,117],[423,125]]
var player ={"kisihida": "../" + language + "/firsttext/fox_1.png", "BLUE":"../" + language + "/firsttext/panda_1.png", "GREEN":"../" + language + "/firsttext/mouse_1.png", "YELLOW":"../" + language + "/firsttext/lion_1.png", "PURPLE":"../" + language + "/firsttext/flog_1.png","red_everyone":"../" + language + "/firsttext/animal_everyone.png","blue_everyone":"../" + language + "/firsttext/animal_everyone.png","green_everyone":"../" + language + "/firsttext/animal_everyone.png","yellow_everyone": "../" + language + "/firsttext/animal_everyone.png","purple_everyone":"../" + language + "/firsttext/animal_everyone.png","res_panda":"../" + language + "/firsttext/res_panda.png","res_fox":"../" + language + "/firsttext/res_fox.png","res_mouse":"../" + language + "/firsttext/res_mouse.png","res_lion":"../" + language + "/firsttext/res_lion.png","res_flog":"../" + language + "/firsttext/res_flog.png"};
...
async function CommentScreen(get_text,wordSize){
  ...
  text_element.width = 0.3 * fontSize[get_text][0]
  text_element.height = 0.6 * fontSize[get_text][1] 
  ...
  if(resEveryone_flag){
    if(userName = "kishida"){
      ...
      res_element.width = 0.8 * fontSize[get_text][0]//[0]はfontsizeの配列1つ目[300,300](300)
      res_element.height = 0.8 * fontSize[get_text][1]//[1]はfontsizeの配列2つ目[300,300](300)
    ...
    resBlue_element.src = player["res_panda"] 
    ...
    resRed_element.src = player["res_fox"] 
    ...
    resGreen_element.src = player["res_mouse"] 
    ...
    resYellow_element.src = player["res_lion"] 
    ...
    resPurple_element.src = player["res_flog"] 
  ...
  /*else if( resA_flag = true ){
    console.log("Aに対して")
    let res_element = document.createElement('img');
    res_element.src = player["res_A"]
    res_element.width = 0.6 * fontSize[get_text][0]
    res_element.height = 0.6 * fontSize[get_text] [1]
    div_text.appendChild(res_element);
  }*/

  //連想配列内の要素を使用して、識別名div要素を追加
...
document.addEventListener("keydown", event2 => {
  if(event2.key === "W"){
    console.log("まだいけるカウント開始")
    body.style.visibility = "visible";
    Qre_flag2 = true;
    windouw.setTimeout(function(){
      clearCanvas2();
      console.log("まだいけるカウント終了")
    }, 15000)
  }
})
*/
